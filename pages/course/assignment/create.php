...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $result = $assignment->createAssignment($title, $description, $score, $attachmentUrl, $courseId);
        ...
        header("Location: ../show.php?id=$courseId&message=Assignment added successfully");
    exit;
}
?>
<!DOCTYPE html>
        ...
        <main class="flex-1 p-6 bg-gray-100">
            ...
            <div class="p-6 mt-6 bg-white rounded-lg shadow-md">
                <form action="<?= $_SERVER['PHP_SELF'] ?>?id=<?= $_GET['id'] ?>" method="POST" enctype="multipart/form-data">
                    ...
                    <!-- File Upload Field -->
                    <div class="mb-4">
                        <label for="assignment-file" class="block text-gray-700 font-medium">Upload File</label>
